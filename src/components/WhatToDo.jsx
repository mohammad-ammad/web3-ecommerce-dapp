    ...
    <div className='p-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-3'>
            ...
            <div className='text-center'>
                ...
                <p className='text-sm text-slate-700'>All physical goods are backed on the blockchain through an NFT, which is the proof of provenance, authenticity and ownership. </p>
            </div>
            <div className='text-center'>
