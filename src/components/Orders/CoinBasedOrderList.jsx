...
const CoinBasedOrderList = () => {

  //---USECONTEXT
  const {createSellerCoinList} = useContext(EscrowContext)
  return (
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg my-3">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {
              createSellerCoinList.length > 0 ? createSellerCoinList.map((item,index) => (
...
export default CoinBasedOrderList